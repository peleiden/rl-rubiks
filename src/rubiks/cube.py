...
class State:
	...
	corners = torch.arange(8)
	corner_orientations = torch.zeros(8)
	sides = torch.arange(12)
	side_orientations = torch.zeros(12)
	def __str__(self):
...
class Actions:
	R: (
		((7, 3), (3, 2), (2, 6), (6, 7)),  # Corner mapping
		((3, 6), (6, 11), (11, 7), (7, 3)),  # Side mapping
		(0, 2),  # Corner orientation mapping
		True,  # Side orientation mapping
	)
